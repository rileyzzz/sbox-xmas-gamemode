...
{
	public class TopDownAnimator : PawnAnimator
	{
		...
		public override void Simulate()
		{
			...
			var idealRotation = Velocity.Length > 0.01f ? Rotation.FromYaw( MathF.Atan2(Velocity.y, Velocity.x).RadianToDegree() ) : Rotation;
